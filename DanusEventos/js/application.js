$(function () {
  ...
  let footer = `
    <footer class="d-flex justify-content-between flex-wrap p-2 bg-dark fixed-bottom  ">
  ...
  function crearTarea(listaDelUsuario) {
    renderizarLista(
      crearTabla(listaDelUsuario),
      document.getElementById("divLista")
    );
  }
  ...
  function crearTabla(items) {
    ...
    btnWp.onclick = () => {
      let productosParaWsp = listaDelUsuario.map(
      ...
      a.target = "_blank";
      a.href =
        "https://wa.me/5491136825679?text=Me%20interesan%20los%20siguientes%20productos%0a%0a" +
        " " +
